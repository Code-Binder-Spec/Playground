...
async def actual_agentic_function(messages,groq_tools,session):
        ...
        while True:
                            ...
                            if message.tool_calls:
                                        ...
                                        limit_char = getting_limit_char_of_model(raw_response)
                                        if len(combined_text) > limit_char:
                                                 data = ("correct",combined_text,"Model limit passed : The ai cant verify or structure the data because the request limit is passed by the amount of data . Upgrade the model to higher version for more request tokens")
                                                 break
                                        messages.append(
                                                                         {
                                                                             "role":"tool",
...
async def main():
                try:
                        ...
                        print(f"Error occured from model side . ERROR : {e}")
                except Exception as e :
                        print(f"Error occured from code . ERROR : {e}")
